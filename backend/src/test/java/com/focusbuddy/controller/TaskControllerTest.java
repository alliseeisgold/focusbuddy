...
class TaskControllerTest {
    ...
    void shouldCreatePlannedTask() {
        TaskDto taskDto = new TaskDto("Planned Task", "Future Task", LocalDate.now().plusDays(2), false, false);
    ...
    void shouldThrowExceptionForPastPlannedTask() {
        TaskDto taskDto = new TaskDto("Old Task", "Past Task", LocalDate.now().minusDays(1), false, false);

        assertThrows(IllegalArgumentException.class, () -> taskController.createPlannedTask(testUser, taskDto));
    }
    ...
    void shouldUpdateTask() {
        TaskDto updateDto = new TaskDto("Updated Task", "Updated Desc", LocalDate.now().plusDays(1), true, false);
